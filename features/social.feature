...
Feature: Social Domain Business Rules
  ...
  @view @target:post_detail_view @blocking @rule:PublicPostViewable
  ...
  @view @target:post_detail_view @rule:VerifiedAuthorPriority
  ...
  @view @target:comment_detail_view @rule:HighEngagementComment
  ...
  @view @target:user_stats_view @rule:ActiveContentCreator
  ...
  @view @target:trending_posts_view @rule:TrendingPostScoring
  ...
  @view @target:user_feed_view @blocking @rule:FeedPostAccessible
